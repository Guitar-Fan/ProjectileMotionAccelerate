...
export const forceProfiles: ForceProfile[] = [
  {
    ...
    spinAxis: new THREE.Vector3(0, 1, 1).normalize(),
    spinRate: 25,
    launchElevation: 25,
    launchPosition: new THREE.Vector3(0, 1.2, 0),
    icon: '/assets/sprites/cannon.png'
  },
  {
    id: 'kick',
    label: 'Midfield Kick',
    ...
    spinAxis: new THREE.Vector3(1, 0, 1).normalize(),
    spinRate: -45,
    launchElevation: 35,
    launchPosition: new THREE.Vector3(-5, 1.2, 3),
    icon: '/assets/sprites/kick.png'
  },
  {
    id: 'bat',
    label: 'Ash Bat Crank',
    ...
    spinAxis: new THREE.Vector3(1, 0.5, 0).normalize(),
    spinRate: 55,
    launchElevation: 45,
    launchPosition: new THREE.Vector3(3, 1.2, -4),
    icon: '/assets/sprites/bat.png'
  },
  {
    id: 'throw',
    label: 'Hand Throw',
  ...
  },
  {
    ...
    spinAxis: new THREE.Vector3(1, 0.5, 1).normalize(),
    spinRate: 30,
    launchElevation: 30,
    launchPosition: new THREE.Vector3(-6, 1.2, -6),
    icon: '/assets/sprites/rail.png'
  }
];
